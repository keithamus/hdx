...
mod kw {
	...
	custom_keyword!(Srgb, atom!("srgb"));
	custom_keyword!(SrgbLinear, atom!("srgb-linear"));
	custom_keyword!(DisplayP3, atom!("display-p3"));
	custom_keyword!(A98Rgb, atom!("a98-rgb"));
	custom_keyword!(ProphotoRgb, atom!("prophoto-rgb"));
	custom_keyword!(Rec2020, atom!("rec2020"));
	custom_keyword!(Xyz, atom!("xyz"));
	custom_keyword!(XyzD50, atom!("xyz-d50"));
	custom_keyword!(XyzD65, atom!("xyz-d65"));
}
...
pub enum ColorSpace {
	Srgb(kw::Srgb),
	SrgbLinear(kw::SrgbLinear),
	DisplayP3(kw::DisplayP3),
	A98Rgb(kw::A98Rgb),
	ProphotoRgb(kw::ProphotoRgb),
	Rec2020(kw::Rec2020),
	Xyz(kw::Xyz),
	XyzD50(kw::XyzD50),
	XyzD65(kw::XyzD65),
...
impl<'a> Build<'a> for ColorSpace {
	fn build(p: &Parser<'a>, c: hdx_lexer::Cursor) -> Self {
		match p.parse_atom_lower(c) {
			atom!("srgb") => Self::Srgb(kw::Srgb::build(p, c)),
			atom!("srgb-linear") => Self::SrgbLinear(kw::SrgbLinear::build(p, c)),
			atom!("display-p3") => Self::DisplayP3(kw::DisplayP3::build(p, c)),
			atom!("a98-rgb") => Self::A98Rgb(kw::A98Rgb::build(p, c)),
			atom!("prophoto-rgb") => Self::ProphotoRgb(kw::ProphotoRgb::build(p, c)),
			atom!("rec2020") => Self::Rec2020(kw::Rec2020::build(p, c)),
			atom!("xyz") => Self::Xyz(kw::Xyz::build(p, c)),
			atom!("xyz-d50") => Self::XyzD50(kw::XyzD50::build(p, c)),
			atom!("xyz-d65") => Self::XyzD65(kw::XyzD65::build(p, c)),
			_ => unreachable!(),
		}
	}
}
