...
mod tests {
	...
	fn size_test() {
		...
		assert_size!(OverflowClipMarginTopStyleValue, 28);
		assert_size!(OverflowClipMarginRightStyleValue, 28);
		assert_size!(OverflowClipMarginBottomStyleValue, 28);
		assert_size!(OverflowClipMarginLeftStyleValue, 28);
		assert_size!(OverflowClipMarginInlineStartStyleValue, 28);
		assert_size!(OverflowClipMarginBlockEndStyleValue, 28);
		assert_size!(OverflowClipMarginInlineEndStyleValue, 28);
		assert_size!(OverflowClipMarginInlineStyleValue, 28);
		assert_size!(OverflowClipMarginBlockStyleValue, 28);
