...
properties! {
	...
	// (See below for -webkit-lint-clamp
	...
	Zoom: atom!("zoom"),
	BoxAlign: atom!("box-align"),
	BoxDirection: atom!("box-direction"),
	BoxFlex: atom!("box-flex"),
	BoxFlexGroup: atom!("box-flex-group"),
	BoxLines: atom!("box-lines"),
	...
	WebkitAlignItems: atom!("-webkit-align-items"),
	WebkitAlignSelf: atom!("-webkit-align-self"),
	WebkitAnimation: atom!("-webkit-animation"),
	...
	WebkitAnimationName: atom!("-webkit-animation-name"),
	WebkitAnimationTimingFunction: atom!("-webkit-animation-timing-function"),
	WebkitAppearance: atom!("-webkit-appearance"),
	WebkitBackdropFilter: atom!("-webkit-backdrop-filter"),
	WebkitBackfaceVisibility: atom!("-webkit-backface-visibility"),
	WebkitBackgroundClip: atom!("-webkit-background-clip"),
	WebkitBoxAlign: atom!("-webkit-box-align"),
	WebkitBoxDecorationBreak: atom!("-webkit-box-decoration-break"),
	WebkitBoxDirection: atom!("-webkit-box-direction"),
	WebkitBoxFlex: atom!("-webkit-box-flex"),
	WebkitBoxOrdinalGroup: atom!("-webkit-box-ordinal-group"),
	WebkitBoxOrient: atom!("-webkit-box-orient"),
	WebkitBoxPack: atom!("-webkit-box-pack"),
	WebkitBoxReflect: atom!("-webkit-box-reflect"),
	WebkitBoxShadow: atom!("-webkit-box-shadow"),
	WebkitBoxSizing: atom!("-webkit-box-sizing"),
	WebkitClipPath: atom!("-webkit-clip-path"),
	WebkitColumnCount: atom!("-webkit-column-count"),
	WebkitColumnGap: atom!("-webkit-column-gap"),
	WebkitFilter: atom!("-webkit-filter"),
	WebkitFlex: atom!("-webkit-flex"),
	WebkitFlexBasis: atom!("-webkit-flex-basis"),
	WebkitFlexDirection: atom!("-webkit-flex-direction"),
	WebkitFlexFlow: atom!("-webkit-flex-flow"),
	WebkitFlexGrow: atom!("-webkit-flex-grow"),
	WebkitFlexWrap: atom!("-webkit-flex-wrap"),
	WebkitFontSmoothing: atom!("-webkit-font-smoothing"),
	WebkitJustifyContent: atom!("-webkit-justify-content"),
	WebkitLineClamp: atom!("-webkit-line-clamp"),
	WebkitMarginEnd: atom!("-webkit-margin-end"),
	WebkitMaskAttachment: atom!("-webkit-mask-attachment"),
	WebkitMaskBoxImage: atom!("-webkit-mask-box-image"),
	WebkitMaskComposite: atom!("-webkit-mask-composite"),
	WebkitMaskImage: atom!("-webkit-mask-image"),
	WebkitMaskPosition: atom!("-webkit-mask-position"),
	WebkitMaskPositionX: atom!("-webkit-mask-position-x"),
	WebkitMaskPositionY: atom!("-webkit-mask-position-y"),
	WebkitMaskRepeatX: atom!("-webkit-mask-repeat-x"),
	WebkitMaskRepeatY: atom!("-webkit-mask-repeat-y"),
	WebkitMaskSize: atom!("-webkit-mask-size"),
	WebkitOrder: atom!("-webkit-order"),
	WebkitOverflowScrolling: atom!("-webkit-overflow-scrolling"),
	WebkitPrintColorAdjust: atom!("-webkit-print-color-adjust"),
	WebkitSlideThumb: atom!("-webkit-slider-thumb"),
	WebkitTapHighlightColor: atom!("-webkit-tap-highlight-color"),
	WebkitTextDecoration: atom!("-webkit-text-decoration"),
	WebkitTextDecorationColor: atom!("-webkit-text-decoration-color"),
	WebkitTextDecorationSkipInk: atom!("-webkit-text-decoration-skip-ink"),
	WebkitTextSizeAdjust: atom!("-webkit-text-size-adjust"),
	WebkitTouchCallout: atom!("-webkit-touch-callout"),
	WebkitTransform: atom!("-webkit-transform"),
	WebkitTransformOrigin: atom!("-webkit-transform-origin"),
	WebkitTransition: atom!("-webkit-transition"),
	WebkitTransitionDelay: atom!("-webkit-transition-delay"),
	WebkitTransitionDuration: atom!("-webkit-transition-duration"),
	WebkitTransitionProperty: atom!("-webkit-transition-property"),
	WebkitTransitionTimingFunction: atom!("-webkit-transition-timing-function"),
	WebkitUserDrag: atom!("-webkit-user-drag"),
	WebkitUserSelect: atom!("-webkit-user-select"),

	// Mozilla NonStandards
	MozAppearance: atom!("-moz-appearance"),
	MozBoxSizing: atom!("-moz-box-sizing"),
	MozColumnCount: atom!("-moz-column-count"),
	MozColumnGap: atom!("-moz-column-gap"),
	MozFloatEdge: atom!("-moz-float-edge"),
	MozForceBrokenImageIcon: atom!("-moz-force-broken-image-icon"),
	MozImageRegion: atom!("-moz-image-region"),
	MozOsxFontSmoothing: atom!("-moz-osx-font-smoothing"),
	MozRangeThumb: atom!("-moz-range-thumb"),
	MozTabSize: atom!("-moz-tab-size"),
	MozTransition: atom!("-moz-transition"),
	MozUserFocus: atom!("-moz-user-focus"),
	MozUserInput: atom!("-moz-user-input"),
	MozUserSelect: atom!("-moz-user-select"),

	// Opera NonStandards
	OBoxSizing: atom!("-o-box-sizing"),
	OObjectFit: atom!("-o-object-fit"),

	// MS NonStandards
	MsBoxSizing: atom!("-ms-box-sizing"),
	MsFilter: atom!("-ms-filter"),
	MsFlex: atom!("-ms-flex"),
	MsFlexAlign: atom!("-ms-flex-align"),
	MsFlexDirection: atom!("-ms-flex-direction"),
	MsFlexFlow: atom!("-ms-flex-flow"),
	MsFlexItemAlign: atom!("-ms-flex-item-align"),
	MsFlexLinePack: atom!("-ms-flex-line-pack"),
	MsFlexNegative: atom!("-ms-flex-negative"),
	MsFlexOrder: atom!("-ms-flex-order"),
	MsFlexPack: atom!("-ms-flex-pack"),
	MsFlexPositive: atom!("-ms-flex-positive"),
	MsFlexPreferredSize: atom!("-ms-flex-preferred-size"),
	MsFlexWrap: atom!("-ms-flex-wrap"),
	MsInterpolationMode: atom!("-ms-interpolation-mode"),
	MsOverflowStyle: atom!("-ms-overflow-style"),
	MsTextSizeAdjust: atom!("-ms-text-size-adjust"),
	MsTouchAction: atom!("-ms-touch-action"),
	MsTransform: atom!("-ms-transform"),
	MsTransformOrigin: atom!("-ms-transform-origin"),
	MsTransition: atom!("-ms-transition"),
	MsUserSelect: atom!("-ms-user-select"),
